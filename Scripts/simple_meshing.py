...
spl_mesh, info = pymesh.split_long_edges(elec_base_vcc, 0.5)
elec_base_vcc, info = pymesh.collapse_short_edges(spl_mesh, 0.1, preserve_feature=True)
...
spl_mesh, info = pymesh.split_long_edges(elec_base_gnd, 0.5)
